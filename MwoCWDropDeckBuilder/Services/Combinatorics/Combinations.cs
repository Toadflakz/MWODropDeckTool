...
namespace Facet.Combinatorics {
    ...
    public class Combinations<T> : IMetaCollection<T> {
        ...
        public class Enumerator : IEnumerator<IList<T>>
        {
            ...
            private static ILog _log = LogManager.GetLogger(typeof (Enumerator));
            ...
            private void ComputeCurrent() {
                ...
                {
                    //var timer = PerformanceHelper.Start();
                    
                    int index = 0;
                    IList<bool> currentPermutation = (IList<bool>)myPermutationsEnumerator.Current;

                    //var blockingList = new BlockingCollection<T>();
                    //Parallel.For(0, currentPermutation.Count, i =>
                    //{
                    //    if (currentPermutation[i] == false)
                    //    {
                    //        blockingList.Add(myParent.myValues[index]);
                    ...
                    //    }
                    //});
                    //myCurrentList = blockingList.ToList();
                    ...
                    //_log.DebugFormat("ComputeCurrent() - {0}ms", PerformanceHelper.Stop(timer));
                }
            }
